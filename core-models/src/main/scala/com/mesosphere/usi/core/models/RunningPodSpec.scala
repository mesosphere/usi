...
object RunningPodSpec {
  ...
  /**
    ...
    */
  private def validateStaticRangeRequirementsUnique(runSpec: SimpleRunTemplate): Seq[ValidationMessage] = {
  ...
  def isValid(runSpec: SimpleRunTemplate): Seq[ValidationMessage] = {
