...
trait AkkaUnitTestLike extends UnitTestLike {
  ...
  implicit lazy val actorMaterializerSettings = ActorMaterializerSettings(system)
  implicit lazy val mat: Materializer = ActorMaterializer(actorMaterializerSettings)
