...
trait TemplateRepositoryLike {
  ...
  /**
    ...
    * This allows us to store multiple entries with the same [[PathId]] e.g. multiple versions of an AppDefinition
  ...
  /**
    ...
    * to read a stored one. This is because decoding bytes is different for app and pod definitions.
...
object TemplateRepositoryLike {
  ...
  /**
    * Duck typing existing AppDefinition and PodDefinition
    ...
    *
    * Note: both encode to and decode from byte arrays methods are part of the USIState
